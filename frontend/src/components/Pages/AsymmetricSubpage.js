				...
				<Tab.Pane>
					{!selectedKey.PublicKey ? (
						<Message
							...
							<h3>No valid key!</h3>
							<p>
								Select a valid <b>public key</b> from the list on the left to encrypt using
								RSA.
							</p>
						</Message>
					) : (
				...
				<Tab.Pane>
					{!selectedKey.PrivateKey ? (
						<Message
							...
							<h3>No valid key!</h3>
							<p>
								Select a valid <b>private key</b> from the list on the left to decrypt using
								RSA.
							</p>
						</Message>
					) : (
				...
				<Tab.Pane>
					{!selectedKey.PrivateKey ? (
						<Message
							...
							<h3>No valid key!</h3>
							<p>
								Select a valid <b>private key</b> from the list on the left to sign using
								RSA.
							</p>
						</Message>
					) : (
				...
				<Tab.Pane>
					{!selectedKey.PublicKey ? (
						<Message
							...
							<h3>No valid key!</h3>
							<p>
								Select a valid <b>public key</b> from the list on the left to verify using
								RSA.
							</p>
						</Message>
					) : (
